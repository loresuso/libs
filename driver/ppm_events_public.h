...
enum ppm_event_type {
	...
	PPME_SECURITY_FILE_OPEN_E = 378,
	PPME_SECURITY_FILE_OPEN_X = 379,
	PPME_SECURITY_BPRM_CREDS_FOR_EXEC_E = 380,
	PPME_SECURITY_BPRM_CREDS_FOR_EXEC_X = 381,
	PPME_SECURITY_INODE_UNLINK_E = 382,
	PPME_SECURITY_INODE_UNLINK_X = 383,
	PPME_SECURITY_SOCKET_ACCEPT_E = 384,
	PPME_SECURITY_SOCKET_ACCEPT_X = 385,
	PPME_SECURITY_SOCKET_BIND_E = 386,
	PPME_SECURITY_SOCKET_BIND_X = 387,
	PPME_SECURITY_SOCKET_CONNECT_E = 388,
	PPME_SECURITY_SOCKET_CONNECT_X = 389,
	PPME_SECURITY_SOCKET_CREATE_E = 390,
	PPME_SECURITY_SOCKET_CREATE_X = 391,
	PPME_SECURITY_SOCKET_LISTEN_E = 392,
	PPME_SECURITY_SOCKET_LISTEN_X = 393,
	PPME_SECURITY_SB_MOUNT_E = 394,
	PPME_SECURITY_SB_MOUNT_X = 395,
	PPM_EVENT_MAX = 396
};
/*@}*/
...
enum ppm_event_category {
	...
	EC_SECURITY = (1 << 13), /* Event generated from security kernel hook points */
};
